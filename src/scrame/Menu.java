 ...
 * This is the menu class of the application.
 */
...
public class Menu {
    ...
    /**
     * showMenu method is the top level UI Menu. It is displayed on the Boot Splash Screen. It is used to select the entity you want to perform an operation on.
     */

    public static void showMenu() {
        System.out.println();
        System.out.println("*********************************************************************************************\n");
        System.out.println("WELCOME TO SCRAME APPLICATION - COURSE REGISTRATION AND MANAGEMENT MADE EASY\n\n");
        System.out.println("*********************************************************************************************\n\n");
        System.out.println("****************\n");
        System.out.println("MAIN MENU\n");
        System.out.println("****************\n\n");
        System.out.println("***************************************************\n");
        System.out.println("Please choose a sub-menu from the below options \n to perform further operations\n");
        System.out.println("***************************************************\n\n");
        System.out.println("(1) Professors Menu");
        System.out.println("(2) Students Menu");
        System.out.println("(3) Courses Menu");
        System.out.println("(4) Course components Menu");
    ...
    /**
     * This is a overloaded method with a parameter of the menu title from the above top level menu.
     * @param MenuTitle
     */
    ...
    public static void showMenu(String MenuTitle) {
        ...
        System.out.println("***************************************************");
        System.out.println("(1) Display " + MenuTitle.toLowerCase() + "s");
    ...
    /**
     * This is a method with a parameter of the menu title from the above top level menu.
     * @param MenuTitle
     */
    ...
    /**
     * This method is used to terminate application state.
     */
    ...
    /**
     * This method is to perform operations on the Course component menu like adding, removing and various other functions.
     * @param courseCode        This is the code of the course whose components needs to be manipulated
     */

    public static void courseComponentMenu(String courseCode)
    {
        String choice="";
        Course c = Course.getCourseByCode(courseCode);
        ...
        do {
            ...
            List componentList = Component.getComponentListByCourse(courseCode);
            ...
            switch (choice)
            {
                case "a":
                    do {
                        ...
                        componentChoice = CheckType.getString();
                        ...
                        switch (componentChoice) {
                            case "1":
                                type = "assignment";
                                Component newCC = new Component(c.getCode(), 0, type, "");
                                newCC.processNewComponent();
                                break;

                            case "2":
                                type = "attendance";
                                newCC = new Component(c.getCode(), 0, type, "");
                                newCC.processNewComponent();
                                break;
                            ...
                            case "0":
                                System.out.println("Exiting to " + c.getCode() + " components list >>>>");
                                break;
                                    ...
                                    case "2":
                                        ...
                                        try {
                                            ...
                                            if (_weightage > 0) {
                                                ...
                                                System.out.println("Invalid weightage. Component weightage has to be more than 0%.");
                                            }
                                        }
                                        catch (Exception e) {
                                            System.out.println("Invalid weightage. Only digits are allowed");
                                        }
                                        break;
                                        ...
                                        do {
                                            ...
                                            for (int i = 0; i < registerList.size(); i++) {
                                                ...
                                                if (r.getCourse().equals(c.getCode())) {
                                                    ...
                                                    studentList.add(s);
                                                    System.out.println(studentList.size() + ") " + s.getName() + " (" + s.getStudentMatric() + "): " + cc.getMarks(s));
                                                }
                                            }
                                            System.out.println();
                                            ...
                                            marksChoice = CheckType.getString();

                                            switch (marksChoice) {
                                                case "0":
                                                    System.out.println("Exiting to " + TextFormat.capitalize(cc.getType()) + " " + cc.getName() + " menu >>>>");
                                                    break;
                                                ...
                                                default:
                                                    try {
                                                        ...
                                                        if (studentChoice > 0 && studentChoice <= studentList.size()) {
                                                            ...
                                                            try {
                                                                int studentMarks = CheckType.getInt();
                                                                if (studentMarks > 100)
                                                                    System.out.println("Invalid marks. Cannot be more than 100%");
                                                                else if (studentMarks < 0)
                                                                    System.out.println("Invalid marks. Cannot be less than 0%");
                                                                else {
                                                                ...
                                                                System.out.println("Invalid mark. Only digits are allowed");
                                                            }
