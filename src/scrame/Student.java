 ...
 *
 * This Student class contains all the fields and methods which perform extensive operations on the Student object. This class inherits Person class
 * and therfore inherits this person's data.
 */
public class Student extends Person implements Comparable<Student>{

    /**
     * The year of study of this student
     */
    private int studentYear;

    /**
     * The matric number of this student
     */
    ...
    /**
     * The constructor of this class which initialises the new objects of this class with its default values when no parameters are specified
     */
    public Student() {
        super("", "", 0);
        studentYear = 1;
    ...
    /**
     * The constructor of this class which initialises the new objects of this class with the parameters which have been passes
     * @param name                      The name of this Student
     * @param email                     The email of this student
     * @param contact                   The contact of this student
     * @param studentYear               The Year of study of this student
     * @param studentMatric             The matric number of this student
     * @param studentGender             The gender of this student
     * @param studentAddress            The address of this student
     */
     ...
     * @return studentYear              Year of study of the student
     */
     ...
     * @return studentMatric             Matric number of the student
     */
     ...
     * @return  studentGender            Gender of the student
     */
    ...
    /**
     * This method checks if the matric number of parameter object and this (current buffer) object's matric number is equal
     * @param O
     * @return          Boolean indicator of whether the numbers are equal or not
     */
    ...
    /**
     * This method gets the student by passing the matric number as a parameter. This data is stored in student.dat
     * @param studentMatric
     * @return
     */
    ...
    /**
     * This method gets the student by passing the matric number and filename as a parameter
     * @param studentMatric
     * @param file
     * @return
     */
    ...
    /**
     * The method gets the list of students from the file name which is passed as a parameter
     * @param file          Name of the file which contains these records
     * @return list         List of students from the file
     */
    ...
    /**
     * This method validates if the input is valid
     * @return
     */
    ...
    /**
     * This methods sets the year of the students
     * @param studentYear       The year of study of the student
     */
    ...
    /**
     * This methods sets the year of the students
     * @param studentGender       The gender of the student
     */
    ...
    /**
     * This method updates the name the student in the records
     */
    ...
    /**
     * This method updates the matric number the student in the records
     */
    ...
    /**
     * This method updates the year of study the student in the records
     */
    ...
    /**
     * This method enrolls the student in this class
     * @param course
     */
    ...
    /**
     * This method shows the Menu for the student. It is basically a UI method which is a sub menu under the top level UI class
     */
    ...
    /**
     * This method displays all the relevant information about the student who is passed as a parameter
     * @param s         Student whose info is to be displayed
     * @return
     */
    ...
    /**
     * This method prints the transcript of the student by performing the various functions to calculate the grade and the GPA
     */
    ...
    /**
     * This method is used to edit the information about the student sent as a parameter
     * @param s         Student whose records are to be edited
     */
    ...
    /**
     * This method writes the data in the list to the file student.dat
     * @param list
     */
    ...
    /**
     * This method searches for the presence of this student's records in the database
     * @param searchStr         The name of this student to be searched in the database
     */
